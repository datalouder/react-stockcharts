  ...
  _createClass(LinearRegressionChannelWithArea, [{
    ...
    value: function renderSVG(moreProps) {
      ...
      return _react2.default.createElement(
        'g',
        null,
        _react2.default.createElement('line', _extends({}, line, { x1: x1, y1: y1 - dy, x2: x2, y2: y2 - dy })),
        _react2.default.createElement('line', _extends({}, line, { x1: x1, y1: y1 + dy, x2: x2, y2: y2 + dy })),
        _react2.default.createElement('path', { d: ctx.toString(), fill: fill, fillOpacity: fillOpacity }),
        _react2.default.createElement('line', _extends({}, line, { x1: x1, y1: y1, x2: x2, y2: y2 }))
      );
    }
  }, {
    key: 'render',
