...
var Annotate = function (_Component) {
  ...
  _createClass(Annotate, [{
    ...
    value: function render() {
      return _react2.default.createElement(_GenericChartComponent2.default, { svgDraw: this.renderSVG, drawOn: ['pan'] });
    }
  }, {
    key: 'renderSVG',
    value: function renderSVG(moreProps) {
      ...
      return _react2.default.createElement(
        ...
        data.map(function (d, idx) {
          return _react2.default.createElement(Annotation, _extends({
            key: idx
          }, usingProps, {
            xScale: xScale,
            yScale: yScale,
