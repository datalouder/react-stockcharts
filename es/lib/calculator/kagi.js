  ...
  function calculator(data) {
    ...
    data.forEach(function (d) {
      ...
      if (line.close >= line.open /* going up */ && priceMovement > 0 || /* and moving in same direction */line.close < line.open /* going down */ && priceMovement < 0 /* and moving in same direction */
        ...
        } else if (line.close >= line.open /* going up */ && priceMovement < 0 /* and moving in other direction */ && Math.abs(priceMovement) > reversalThreshold(d) || /* and the movement is big enough for reversal */line.close < line.open /* going down */ && priceMovement > 0 /* and moving in other direction */ && Math.abs(priceMovement) > reversalThreshold(d) /* and the movement is big enough for reversal */
      ) {
          // reverse direction
